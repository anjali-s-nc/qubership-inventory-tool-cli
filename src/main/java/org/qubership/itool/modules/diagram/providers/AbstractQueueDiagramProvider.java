...
public abstract class AbstractQueueDiagramProvider implements DiagramProvider {
    ...
    protected Boolean queueHasDualLinkToComponent(List<Map<String, Object>> componentsList,
            String queueName, String checkedComponentName, String componentNameKey) {
