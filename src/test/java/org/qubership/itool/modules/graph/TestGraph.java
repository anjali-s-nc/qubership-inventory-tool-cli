...
public class TestGraph {
    ...
    void testRelocateVertex() {
        ...
        var vertex_1_1 = this.graph.traversal().V(V_ROOT).out().out().has(F_NAME, P.eq("name_1_1"))
                .dedup().next();
        Assertions.assertEquals("vertex_1_1", vertex_1_1.getString(F_ID));
        var vertex_2 = this.graph.traversal().V(V_ROOT).out().out().has(F_NAME, P.eq("name_1_1"))
                .out().next();
        ...
        var vertex_relocated =
                this.graph.traversal().V(V_ROOT).out().out().has(F_NAME, P.eq("name_1_1")).next();
        Assertions.assertEquals("vertex_relocated", vertex_relocated.getString(F_ID));
        vertex_2 = this.graph.traversal().V(V_ROOT).out().out().has(F_NAME, P.eq("name_1_1")).out()
                .next();
        Assertions.assertNotNull(vertex_2);
        Assertions.assertEquals("vertex_2", vertex_2.getString(F_ID));
