...
import static org.qubership.itool.modules.gremlin2.P.endingWith;
import static org.qubership.itool.modules.gremlin2.P.eq;
import static org.qubership.itool.modules.gremlin2.P.gte;
import static org.qubership.itool.modules.gremlin2.P.inside;
...
import static org.qubership.itool.modules.gremlin2.P.notEndingWith;
import static org.qubership.itool.modules.gremlin2.P.notStartingWith;
...
public class TestGremlinPredicates extends AbstractGremlinTest {
    ...
    void testArray() {
        ...
        JsonObject element_2 = new JsonObject().put("artifactId", "comonent2-suffix")
                .put("groupId", "g2").put("version", "2021.2.0.1-SNAPSHOT");
